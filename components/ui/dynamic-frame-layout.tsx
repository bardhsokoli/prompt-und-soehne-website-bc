      ...
      >
        ...
        <span
          ...
          style={{
            ...
            fontFamily: '"Rocky Condensed Light Italic", serif',
...
export function DynamicFrameLayout({ items }: DynamicFrameLayoutProps) {
  ...
  return (
    ...
    <>
      ...
      <div className="hidden lg:flex flex-col gap-[2px] h-screen w-full">
      ...
      <div className="lg:hidden grid grid-cols-1 sm:grid-cols-2 gap-[2px] min-h-screen">
